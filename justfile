solution := "src/NServiceBus.GuardNoActivity.sln"
project  := "src/NServiceBus.GuardNoActivity/NServiceBus.GuardNoActivity.csproj"
demo     := "src/NServiceBus.GuardNoActivityDemo/NServiceBus.GuardNoActivityDemo.csproj"
config   := "Release"
artifacts := "artifacts"
